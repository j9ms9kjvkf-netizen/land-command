...
const TITLE_FL_SCRIPT = {
  id: "titleFL",
  label: "Script 5",
  title: "Florida Title Company Outreach",
  goal: "Land 2-3 attorney-owned Florida title companies who can draft your contract package AND close your assignments and double closes statewide.",
  accent: "#38bdf8",
  accentDim: "#0b2b3a",
  badge: "TITLE SIDE",
  badgeColor: "#38bdf8",
  steps: [
    {
      ...
      label: "Primer",
      icon: "⚠️",
      intro: "Read this once before your first call. It changes who you are calling.",
      blocks: [
        {
          type: "warn",
          ...
          color: "#fbbf24",
          bg: "#2a2008",
          text: "A Florida title company that is NOT attorney-owned generally cannot draft your contracts. Preparing legal instruments is the practice of law. A non-attorney title agent can fill blanks on standard approved forms for a closing they are handling, but drafting a custom purchase agreement, assignment, or double close package is a different thing.",
        },
        {
          type: "tip",
          ...
          color: "#a78bfa",
          bg: "#1a1030",
          text: "Attorney-owned title agencies are very common in Florida. The attorney side drafts, the title side closes, and you get both relationships from one call. Ask the ownership question in the first 30 seconds so you never burn 10 minutes on an office that can only do half the job.",
        },
        {
          type: "warn",
          ...
          color: "#fbbf24",
          bg: "#2a2008",
          text: "Keep your marketing on your equitable interest in the contract, not on the property. Get the seller disclosure in writing before escrow opens. Have whoever drafts your package confirm both are handled the way Florida expects.",
        },
      ],
      rebuttals: [],
      comeback: ["Confirmed attorney-owned before pitching the drafting", "Have a sample deal file ready to email same day"],
    },
    {
      id: "gatekeeper",
      label: "Gatekeeper",
      icon: "🚪",
      intro: "Front desk screens everything. Two questions decide whether this call is worth continuing.",
      blocks: [
        {
          type: "say",
          label: "Opening Line",
          color: "#22c55e",
          bg: "#0f2a1a",
          text: `"Hi, this is [YOUR NAME] with Arcadia Land Capital. I'm an investor working vacant land across Florida and I'm looking to set up a title company relationship for ongoing closings. Two quick questions before I take up anyone's time — is your office attorney-owned, and do you handle assignments and double closes?"`,
        },
        {
          type: "tip",
          label: "Route The Answer",
          color: "#a78bfa",
          bg: "#1a1030",
          text: "YES to both — ask for the closer, escrow officer, or business development contact.\nNO to attorney-owned — they can still be a great closing shop. Say so and keep going, just drop the drafting ask.\nNO to assignments or double closes — thank them and hang up. Do not try to convert them.",
        },
      ],
      rebuttals: [],
      comeback: ["Attorney-owned: yes / no", "Reached a closer or escrow officer"],
    },
    {
      id: "opening",
      label: "Opening",
      icon: "🎯",
      intro: "You have about 40 seconds to sound like recurring business.",
      blocks: [
        {
          type: "say",
          label: "The Frame",
          color: "#22c55e",
          bg: "#0f2a1a",
          text: `"Thanks for taking the call. Quick background so this is useful for you: I run Arcadia Land Capital. We buy off-market vacant lots direct from motivated sellers across Florida, and we either assign the contract or double close to builders and contractors on the back end. Volume is steady and it's all land — no residential, no financing contingencies, mostly cash on both sides."`,
        },
        {
          type: "say",
          label: "The Two Asks",
          color: "#22c55e",
          bg: "#0f2a1a",
          text: `"I'm calling for two reasons. First, I need a proper contract package put together for Florida. Second, and honestly the bigger one, I'm looking for one title company I can send every Florida deal to instead of hunting for a new closer each county. Is that a fit for how you work?"`,
        },
        {
          type: "tip",
          label: "Why It Works",
          color: "#a78bfa",
          bg: "#1a1030",
          text: "Leads with volume, signals you are not a one-deal tire-kicker, and frames the drafting as the small part of a bigger relationship. Cash, no financing, no inspections reads as easy money to a closer.",
        },
      ],
      rebuttals: [],
      comeback: ["Positioned as recurring volume, not a one-off"],
    },
    {
      id: "documents",
      label: "Documents",
      icon: "📄",
      intro: "The drafting ask. Be specific or you will get a generic form.",
      blocks: [
        {
          type: "say",
          label: "The Ask",
          color: "#22c55e",
          bg: "#0f2a1a",
          text: `"On the drafting side I need three things, and I want them built for repeat use so I'm not paying per deal."`,
        },
        {
          type: "say",
          label: "Document 1",
          color: "#22c55e",
          bg: "#0f2a1a",
          text: `"A vacant land purchase and sale agreement. Seller-side, cash, land-specific. Assignment clause built in, inspection and title review period spelled out, clean default and remedy language. Ideally 'and/or assigns' handled properly rather than bolted on."`,
        },
        {
          type: "say",
          label: "Document 2",
          color: "#22c55e",
          bg: "#0f2a1a",
          text: `"An assignment of contract agreement. Names the assignment fee clearly, releases me from the transaction on closing, and makes the disclosure to both sides clean."`,
        },
        {
          type: "say",
          label: "Document 3",
          color: "#22c55e",
          bg: "#0f2a1a",
          text: `"The paperwork for a double close. The second contract between me and my end buyer, plus whatever you need on your side to run two settlements."`,
        },
        {
          type: "say",
          label: "The Qualifier",
          color: "#22c55e",
          bg: "#0f2a1a",
          text: `"Two things I care about in the drafting. I want the disclosure language to make it obvious I'm marketing my equitable interest in the contract and not brokering the property — I don't want anything that creates a 475.42 problem. And I want this as a statewide template package I can reuse, not per-transaction work. Is that something your attorney takes on, and what does that look like on cost?"`,
        },
        {
          type: "warn",
          label: "The Tell",
          color: "#fbbf24",
          bg: "#2a2008",
          text: "Listen for whether they raise 475.42 or unlicensed brokerage on their own. Unprompted fluency is a strong buy signal. Never heard of it means you carry the compliance load yourself.",
        },
      ],
      rebuttals: [],
      comeback: ["Flat fee quoted, not hourly", "Template package confirmed (reusable, not per-deal)", "They showed 475.42 fluency unprompted"],
    },
    {
      id: "assignments",
      label: "Assignments",
      icon: "✍️",
      intro: "How they treat the fee tells you everything about the fit.",
      blocks: [
        {
          type: "ask",
          label: "Run These",
          color: "#38bdf8",
          bg: "#0b2b3a",
          text: "1. Do you close assignments, and how do you want the assignment fee shown on the settlement statement?\n2. Any cap on the fee before you get uncomfortable?\n3. Do you require the seller to sign off on the assignment, or is contract language enough?\n4. Do you hold earnest money, and what's your minimum?\n5. How fast can you open escrow once I send a signed contract?",
        },
        {
          type: "tip",
          label: "Green Flags",
          color: "#a78bfa",
          bg: "#1a1030",
          text: "Fee on the settlement statement without drama. No arbitrary dollar cap. Escrow opened same or next business day. Anyone who gets squeamish about a visible assignment fee will slow-walk you at the worst possible moment.",
        },
      ],
      rebuttals: [],
      comeback: ["Assignment fee handling confirmed", "EMD minimum + escrow timeline noted"],
    },
    {
      id: "doubleclose",
      label: "Double Close",
      icon: "🔁",
      intro: "The single most important step. This is where most title companies quietly fail you.",
      blocks: [
        {
          type: "ask",
          label: "Run These",
          color: "#38bdf8",
          bg: "#0b2b3a",
          text: "1. Do you facilitate double closes — both settlements same day, same office?\n2. Do you allow the B-to-C funds to fund the A-to-B side, or do I need to bring separate funds?\n3. If separate funds are required, do you work with transactional funding lenders, and any you've closed with before?\n4. Two full sets of title fees, or do you discount the second leg? What's the all-in number?\n5. Whose name goes on the title commitment for the first leg?\n6. Does the end buyer see the A-to-B settlement statement?",
        },
        {
          type: "warn",
          ...
          color: "#fbbf24",
          bg: "#2a2008",
          text: `"We don't do double closes" usually means "we won't let Transaction B fund Transaction A." Those are different problems. The first ends the call. The second is solved with transactional funding. Always find out which one you're hearing.`,
        },
        {
          type: "say",
          label: "If They Hedge",
          color: "#22c55e",
          bg: "#0f2a1a",
          text: `"Is that a policy, or is it about the funding source? Because if the issue is using the end buyer's money to fund the first leg, I can bring separate funds and close them as two independent transactions. Does that change the answer?"`,
        },
      ],
      rebuttals: [],
      comeback: ["Same-day dual settlement confirmed", "Funding rule documented (own funds vs. pass-through)", "All-in double close cost captured for deal math"],
    },
    {
      id: "land",
      label: "Land IQ",
      icon: "🌴",
      intro: "Residential closers choke on land. These questions separate the two.",
      blocks: [
        {
          type: "ask",
          label: "Run These",
          color: "#38bdf8",
          bg: "#0b2b3a",
          text: "1. How much vacant land do you do versus residential?\n2. How do you handle heirs and probate chains?\n3. Unreleased old mortgages and stale liens — what's your process?\n4. Unpaid municipal or code enforcement liens?\n5. Landlocked or no-legal-access parcels — do you flag those or is that on me?\n6. POA or HOA estoppels on platted lots?\n7. Do you require a survey, and do you have surveyors you use?\n8. FIRPTA when the seller is out of the country — how do you handle it?\n9. Do you insure tax deed titles, or do you require quiet title first?",
        },
        {
          type: "tip",
          label: "Why This Matters",
          color: "#a78bfa",
          bg: "#1a1030",
          text: "Absentee and out-of-country owners are the bulk of motivated land sellers. A title company that fumbles FIRPTA or a probate chain will kill deals you already paid to source.",
        },
      ],
      rebuttals: [],
      comeback: ["Real land volume confirmed", "FIRPTA + probate handling understood"],
    },
    {
      id: "logistics",
      label: "Fees & Logistics",
      icon: "💰",
      intro: "Get the numbers so your deal math is never a guess.",
      blocks: [
        {
          type: "ask",
          label: "Run These",
          color: "#38bdf8",
          bg: "#0b2b3a",
          text: "1. Do you close statewide or only certain counties?\n2. Mail-away and remote online notarization — do you do both?\n3. Typical timeline from contract to clear-to-close on a cash land deal?\n4. Who's my day-to-day contact, and fastest way to reach them?\n5. Can you email me your full fee schedule?\n6. Who pays what in your standard land closing — and is that negotiable?",
        },
        {
          type: "tip",
          label: "Statewide Or Bust",
          color: "#a78bfa",
          bg: "#1a1030",
          text: "You buy in four states and all over Florida. A closer limited to two counties becomes a bottleneck the moment your marketing works. Statewide plus RON is the requirement, not the bonus.",
        },
      ],
      rebuttals: [],
      comeback: ["Statewide + RON confirmed", "Fee schedule requested", "Direct contact captured"],
    },
    {
      id: "rebuttals",
      label: "Rebuttals",
      icon: "🛡️",
      intro: "Tap any objection to open the response.",
      blocks: [],
      rebuttals: [
        {
          them: `"We don't work with wholesalers."`,
          you: `"Understood — I've heard that from offices that got burned by someone doing it sloppy. Everything I run is fully disclosed on both sides, the assignment fee shows on the settlement statement, and my seller knows exactly what I'm doing before we ever open escrow. If it'd help, I'll send you a sample file so you can look at how it's papered before you decide."`,
        },
        {
          them: `"We can't draft contracts for you."`,
          you: `"That's fair, and it's why I asked about attorney ownership up front. Two options then — either your attorney handles it on the legal side, or I get the drafting done elsewhere and you're still my closing shop. Which of those works?"`,
        },
        {
          them: `"We don't do double closes."`,
          you: `"Is that a policy, or is it about the funding source? If the issue is using the end buyer's money to fund the first leg, I can bring separate funds and close them as two independent transactions. Does that change the answer?"`,
        },
        {
          them: `"You need to bring your own funds for the A-to-B."`,
          you: `"That's what I expected. Do you have transactional lenders you've closed with before, or should I bring my own?"`,
        },
        {
          them: `"Send me your contract and I'll take a look."`,
          you: `Good sign — that's interest, not a brush-off. Get their direct email, send the sample file the same day, and set a follow-up for two business days out.`,
        },
        {
          them: `"What's your volume?" (when you're just starting)`,
          you: `"I'm building the Florida pipeline right now — marketing is out and I'm underwriting weekly. I'm picking my title company before the volume hits, not after, because I'd rather have one relationship than scramble deal by deal."`,
        },
      ],
      comeback: [],
    },
    {
      ...
      label: "Close",
      icon: "🤝",
      intro: "Lock the contact and create a reason to talk again this week.",
      blocks: [
        {
          type: "say",
          label: "The Close",
          color: "#22c55e",
          bg: "#0f2a1a",
          text: `"This has been useful. Here's what I'd like to do — can you send me your fee schedule and a quote on the document package? I'll get you a sample deal file today so you can see how I paper things. If it looks good on both sides, my next Florida contract comes straight to you. Who should I be sending everything to, and what's the best email?"`,
        },
        {
          type: "tip",
          ...
          color: "#a78bfa",
          bg: "#1a1030",
          text: "Send the recap email before the day ends. Subject: Arcadia Land Capital — FL vacant land closings + contract package. Recap the two asks, attach the sample file, ask for the fee schedule and quote. You go from a voice to a file on their desk.",
        },
      ],
      rebuttals: [],
      comeback: ["Direct name, email, and phone captured", "Fee schedule promised", "Drafting quote promised", "Sample file sent same day", "Follow-up set for 2 business days"],
    },
    {
      id: "voicemail",
      label: "Voicemail",
      icon: "📱",
      intro: "Under 25 seconds. Sound like recurring business walking in.",
      blocks: [
        {
          type: "say",
          label: "Leave This",
          color: "#22c55e",
          bg: "#0f2a1a",
          text: `"Hi, this is [YOUR NAME] with Arcadia Land Capital, [PHONE]. I'm a vacant land investor closing deals across Florida and I'm looking to set up an ongoing title relationship — assignments and double closes, cash on both sides, steady volume. I also need a contract package drafted if your office is attorney-owned. My number again is [PHONE]. Thanks."`,
        },
        {
          type: "tip",
          label: "Voicemail Rules",
          color: "#a78bfa",
          bg: "#1a1030",
          text: "Say your number twice. Lead with ongoing relationship, not a single deal. Never leave the full pitch — leave a reason to call back.",
        },
      ],
      rebuttals: [],
      comeback: [],
