...
const GIS_STATE_APN_FIELD = { FL: "PARCEL_ID", TX: "GEO_ID", TN: "PARCELID", NC: "PARNO", OH: "LocalParcelID", WI: "PARCELID", IN: "parcel_id", AR: "parcelid", VA: "GPIN", PR: "NUM_CATASTRO" };
...
const STATE_ABBR = { "Florida": "FL", "Texas": "TX", "Tennessee": "TN", "North Carolina": "NC", "Virginia": "VA", "Puerto Rico": "PR" };
...
function extractParcelFields(props) {
  ...
  return {
    apn:         pick("PARCEL_ID","APN","PIN","PARCELID","FOLIO","ACCOUNT_NUM","ACCT","GPIN","REID","PIN_NUM","PARCEL","ACCOUNT","PROP_ID","GEO_ID","PARCELNO","PARNO","PARID","PARCELNUMB","NUM_CATASTRO","CATASTRO","CATASTRO_N"),
      ...
      <div ref={registerCtl} style={{ position: "absolute", top: 12, left: 12, right: 58, zIndex: 700, display: "flex", flexDirection: "column", gap: 6, alignItems: "flex-start" }}>
        ...
        <div style={{ display: "flex", gap: 6, width: isMobile ? "100%" : "min(330px, 64vw)" }}>
          <select value={stateFilter} onChange={e => flyToState(e.target.value)} className="gcb" title="State"
            ...
            {["FL","TX","TN","NC","OH","IN","WI","MN","AR","NM","VA","PR"].map(st => <option key={st} value={st} style={{ color: "#111", background: "#fff" }}>{st}</option>)}
          </select>
