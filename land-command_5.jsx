...
const TITLE_CONTRACT_SCRIPT = {
  id: "titleContract",
  label: "Script 5",
  title: "Title Contract Outreach",
  goal: "A short, single-purpose call: find an attorney-owned Florida title company to either draft your 3 land-deal contracts from scratch, or review and edit the ones you already have.",
  accent: "#38bdf8",
  accentDim: "#0b2b3a",
  badge: "TITLE SIDE",
  badgeColor: "#38bdf8",
  steps: [
    {
      ...
      label: "Gatekeeper",
      icon: "🚪",
      intro: "One question decides whether this call is worth continuing. Keep this under a minute.",
      blocks: [
        {
          type: "say",
          label: "Opening Line",
          color: "#22c55e",
          bg: "#0f2a1a",
          text: `"Hi, this is [YOUR NAME]. I'm an investor and I'm looking to get some land purchase contracts drafted or reviewed. Is your office attorney-owned, and is there someone who handles that kind of work?"`,
        },
        {
          type: "tip",
          ...
          color: "#a78bfa",
          bg: "#1a1030",
          text: "YES — ask for that attorney or contact directly.\nNO to attorney-owned — thank them and ask if they know an attorney-owned firm nearby, then hang up. This call is single-purpose, don't try to convert them.",
        },
      ],
      rebuttals: [],
      comeback: ["Confirmed attorney-owned", "Reached the right contact"],
    },
    {
      id: "opener",
      label: "Opener",
      icon: "🎯",
      intro: "30 seconds. State the ask plainly — this is a quick, one-time need.",
      blocks: [
        {
          type: "say",
          label: "The Frame",
          color: "#22c55e",
          bg: "#0f2a1a",
          text: `"Hi [NAME], my name is [YOUR NAME]. I'm an investor buying and selling vacant land here in Florida, and I'm calling about a pretty simple, one-time need — I need three contracts for my land deals, either drafted from scratch or reviewed and cleaned up if I already have versions I'm using. Do you have a few minutes?"`,
        },
        {
          type: "tip",
          label: "Why It Works",
          color: "#a78bfa",
          bg: "#1a1030",
          text: "Short and specific respects their time and gets you a real answer fast instead of a stall.",
        },
      ],
      rebuttals: [],
      comeback: [],
    },
    {
      ...
      label: "The Ask",
      icon: "📄",
      intro: "Name the three documents and give them the two easy paths — draft new, or review what you have.",
      blocks: [
        {
          type: "say",
          label: "Document 1",
          color: "#22c55e",
          bg: "#0f2a1a",
          text: `"A vacant land purchase and sale agreement — seller-side, cash, land-specific, with an assignment clause built in."`,
        },
        {
          type: "say",
          label: "Document 2",
          color: "#22c55e",
          bg: "#0f2a1a",
          text: `"An assignment of contract agreement."`,
        },
        {
          type: "say",
          label: "Document 3",
          color: "#22c55e",
          bg: "#0f2a1a",
          text: `"A double close / back-to-back closing agreement."`,
        },
        {
          type: "say",
          label: "The Two Paths",
          color: "#22c55e",
          bg: "#0f2a1a",
          text: `"I either need these three built from scratch, or — if it's faster — I can send you what I'm currently using and you can review and edit them to make sure they hold up under Florida law. Whichever is quicker on your end works for me."`,
        },
        {
          type: "tip",
          label: "Assignability Clause — Don't Skip This",
          color: "#a78bfa",
          bg: "#1a1030",
          text: `Whether drafted new or edited, the Purchase Agreement needs assignable language ("and/or assigns" after your name as buyer). Say this out loud on the call so it doesn't get missed.`,
        },
      ],
      rebuttals: [],
      comeback: ["Draft-from-scratch OR review/edit confirmed", "Assignability clause requirement mentioned"],
    },
    {
      id: "fees",
      label: "Fees & Close",
      icon: "💰",
      intro: "Get the number and lock the next step. This is the whole rest of the call.",
      blocks: [
        {
          type: "say",
          label: "Ask About Fees",
          color: "#22c55e",
          bg: "#0f2a1a",
          text: `"Can you give me a sense of cost for this — flat fee for the three documents, or hourly? And if I send over what I already have, is reviewing and editing usually cheaper than drafting from scratch?"`,
        },
        {
          type: "say",
          label: "Close The Call",
          color: "#22c55e",
          bg: "#0f2a1a",
          text: `"Here's what I'd like to do — can I send over what I'm currently using today, along with the three documents I need? If you can get me a flat quote and a rough timeline, I can move forward quickly. What's the best email?"`,
        },
      ],
      rebuttals: [],
      comeback: ["Flat fee or hourly rate noted", "Email captured", "Timeline noted", "Docs sent same day"],
    },
    {
      id: "rebuttals",
      label: "Rebuttals",
      ...
      rebuttals: [
        {
          them: `"We're not attorney-owned."`,
          you: `"No problem — do you know an attorney-owned firm nearby that handles this kind of contract work?"`,
        },
        {
          them: `"We don't typically do this kind of contract work for investors."`,
          you: `"Totally understand. Everything I do is fully disclosed — I'm marketing my equitable interest in the contract, not the property itself. If it'd help, I can send a sample of what I'm using so you can see how it's put together before deciding."`,
        },
        {
          them: `"Send over what you have and we'll take a look."`,
          you: `Good sign — that's interest, not a brush-off. Get their direct email and send the sample the same day.`,
        },
      ],
      comeback: [],
    },
    {
      ...
      label: "Voicemail",
      icon: "📱",
      intro: "Under 20 seconds. Leave a reason to call back.",
      blocks: [
        {
          type: "say",
          label: "Leave This",
          color: "#22c55e",
          bg: "#0f2a1a",
          text: `"Hi, this is [YOUR NAME], [PHONE]. I'm a land investor here in Florida and I need three contracts for my land deals either drafted or reviewed and edited by an attorney-owned title company. If that's something your office handles, give me a call back at [PHONE]. Thanks."`,
        },
        {
          type: "tip",
          label: "Voicemail Rules",
          color: "#a78bfa",
          bg: "#1a1030",
          text: "Say your number twice. Keep it under 20 seconds — this is a quick ask, sound like one.",
        },
      ],
      rebuttals: [],
      comeback: [],
...
const CALL_SCRIPTS = {
  ...
  titleContract: TITLE_CONTRACT_SCRIPT,
};
